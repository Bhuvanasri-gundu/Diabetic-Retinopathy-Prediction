...
def load_default_analysis_image():
    ...
    for sample_path in sample_candidates:
        if os.path.exists(sample_path):
            ...
            return preprocess_uploaded_image(sample_file)

    raise FileNotFoundError("No sample retinal image was found in the processed_images folder.")
...
def page_patient_analysis():
    ...
    with col_left:
        st.markdown("""
        <div class="patient-form-title"> Patient Identity</div>
        """, unsafe_allow_html=True)
    ...
    if result is None:
        ...
        <div style="text-align:center;padding:80px 40px;">
            ...
            <p style="color:#64748b;">
                Run analysis from the Patient Analysis page to view results.
            </p>
        </div>
        """, unsafe_allow_html=True)
...
def page_about():
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;
      margin-bottom:24px;">
        <div>
            <p style="color:#0f172a;font-size:18px;font-weight:600;margin-bottom:4px;">
                About DR Vision
            </p>
        </div>
    </div>
    ...
    <div class="dr-card" style="margin-bottom:24px;padding:32px;">
        <h3 style="color:#0D9488;font-weight:800;font-size:22px;margin:12px 0 8px;">
